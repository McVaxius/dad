...
public sealed class DadBuildReleaseWorkflowContractTests
{
    ...
    public void RequiredReleaseTestsUseExplicitSourcesAndBlockArtifactUpload()
    {
        ...
        Assert.Contains(
            "Dad.AutoParty.Protocol.0.2.0-preview.6.nupkg",
            workflow,
            StringComparison.Ordinal);
        Assert.Contains(
            "88a5b8ac6700190b58e9956af6b91b254419784d84eb548a85db925f7d621b4d",
            workflow,
            StringComparison.Ordinal);
        Assert.Contains(
        ...
        Assert.Contains(
            "xAdVJWH//XTTOm4pJ3gUb6UcjUKQcZnm2r1avk901nZBYlDtON9dVpKB4PqxSWn6XVEFPj310na/FsZ/GH2A4w==",
            testLock,
            StringComparison.Ordinal);
        Assert.Contains(
