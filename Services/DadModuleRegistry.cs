...
public sealed class DadModuleRegistry
{
    ...
    public DadModuleRegistry()
    {
        capabilities = new Dictionary<DadModuleId, DadModuleCapabilitySnapshot>
        {
            ...
            [DadModuleId.DailyMsq] = BuildCapability(DadModuleId.DailyMsq, "Daily MSQ", 4, true, false, true, "Premade Daily MSQ live queue start is deferred.", "Premade Daily MSQ queue start is not enabled yet."),
