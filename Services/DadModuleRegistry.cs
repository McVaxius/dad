...
public sealed class DadModuleRegistry
{
    ...
    public DadModuleRegistry()
    {
        capabilities = new Dictionary<DadModuleId, DadModuleCapabilitySnapshot>
        {
            ...
            [DadModuleId.Msq] = BuildCapability(DadModuleId.Msq, "MSQ", 4, true, false, true, "MSQ live queue start remains deferred pending preset/roulette policy.", "MSQ live queue start remains deferred until preset/roulette queue policy is proven."),
            ...
            [DadModuleId.Mogtome] = BuildCapability(DadModuleId.Mogtome, "MOGTOME", 4, true, false, true, "MOGTOME helper handoff is deferred until IPC exists.", "MOGTOME helper queue handoff is not enabled yet."),
            [DadModuleId.Commendation] = BuildCapability(DadModuleId.Commendation, "Commendation", 4, true, false, true, "Commendation queue/task start is deferred.", "Commendation queue/task start is not enabled yet."),
            ...
            [DadModuleId.CustomDuty] = BuildCapability(DadModuleId.CustomDuty, "Custom Duty", 1, false, true, true, "Custom duty live executor contract is missing.", "Custom duty executor is not enabled yet."),
        };
    }
